...
# Database: /path/to/home/projects/magicc2/tools/checkm2_db/CheckM2_database/uniref100.KO.1.dmnd
...
echo "=============================================="
echo "CheckM2 Benchmark Run - $(date)"
echo "=============================================="
...
for SET in A B C D; do
    ...
    LOG_FILE="${LOG_DIR}/checkm2_set_${SET}.log"
...
echo "=============================================="
echo "All sets completed at $(date)"
