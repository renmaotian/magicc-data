#!/bin/bash
# WS11.T — execute results/revision/speed_v3/run_plan_v3.tsv, SERIALLY.
#
...
echo "=================================================================="
echo "WS11.T campaign start $(date -u +%Y-%m-%dT%H:%M:%SZ)"
...
echo "=================================================================="
echo "WS11.T campaign end $(date -u +%Y-%m-%dT%H:%M:%SZ)"
echo "=================================================================="
