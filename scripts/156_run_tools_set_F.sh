...
# benchmark; wall-clock is indicative only and that caveat is written into
...
echo "=============================================================="
echo "WS2.4 competitor runs on ${SET_NAME} -- $(date -Is)"
...
if has_tool checkm2; then
    ...
    LOG="${LOG_DIR}/checkm2_${SET_NAME}.log"
...
if has_tool cocopye; then
    ...
    LOG="${LOG_DIR}/cocopye_${SET_NAME}.log"
...
echo "=============================================================="
echo "WS2.4 tool runs finished -- $(date -Is)"
