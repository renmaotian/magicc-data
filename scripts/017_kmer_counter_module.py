...
def test_load_selected_kmers():
    ...
    kmer_path = '/path/to/home/projects/magicc2/data/kmer_selection/selected_kmers.txt'
...
def test_real_genome():
    ...
    manifest_path = '/path/to/home/projects/magicc2/data/splits/genome_manifest.tsv'
    genomes = []
