...
| Clean Sets C/D driver (fully instrumented) | `data_generating_scripts/73_generate_clean_cd_benchmarks.py` |
| Finished-genome sets A_v2 / B_v2 / E driver | `data_generating_scripts/34_generate_finished_benchmarks.py` |
| Original Sets A–D driver | `data_generating_scripts/25_benchmark_generate.py` |
| Motivating sets driver | `scripts/31_motivating_benchmark_generate.py`, `data_generating_scripts/41_generate_motivating_set_c.py` |
